...
<form3>
    ...
    <texto> Promedio nivel basura </texto>
    ...
    <button type = "submit";  onclick="window.location.href='http://localhost:1880/worldmap/'"; style= "font-family:'Nunito', sans-serif";>Mapa en vivo</button>
      </div> 
